...
const DOMcontrol = (() => {
  ...
  function checkWhetherEditNotes(e) {
    if (e.target.parentNode.parentNode.querySelector(`.task-notes`) || e.target.parentNode.parentNode.querySelector(`.task-notes-expanded`)) {
      let editNotesDiv =
        e.target.parentNode.parentNode.querySelector(`.task-notes`) || e.target.parentNode.parentNode.querySelector(`.task-notes-expanded`);
  ...
  projectViewList.onmouseover = function (e) {
    if (
      e.target.classList.contains('project-placeholder') ||
      e.target.classList.contains('project-placeholder-active') ||
      e.target.classList.contains('project-placeholder-active')
    )
      hoverIcons(e.target, 'project');
    if (
      e.target.parentNode.classList.contains('project-placeholder') ||
      e.target.parentNode.classList.contains('project-placeholder-active') ||
      e.target.parentNode.classList.contains('project-placeholder-active')
    )
      hoverIcons(e.target.parentNode, 'project');
    if (
      e.target.parentNode.parentNode.classList.contains('project-placeholder') ||
      e.target.parentNode.parentNode.classList.contains('project-placeholder-active')
    )
      hoverIcons(e.target.parentNode.parentNode, 'project');
  };

  projectViewList.onmouseout = function (e) {
    if (e.target.classList.contains('project-placeholder') || e.target.classList.contains('project-placeholder-active'))
      rmHoverIcons(e.target, 'project');
    if (e.target.parentNode.classList.contains('project-placeholder') || e.target.parentNode.classList.contains('project-placeholder-active'))
      rmHoverIcons(e.target.parentNode, 'project');
    if (
      e.target.parentNode.parentNode.classList.contains('project-placeholder') ||
      e.target.parentNode.parentNode.classList.contains('project-placeholder-active')
    )
      rmHoverIcons(e.target.parentNode.parentNode, 'project');
  };
  ...
  taskViewList.onclick = function (e) {
    if (
      (e.target.className === 'task-notes' || e.target.className === 'task-notes-expanded') &&
      !e.target.parentNode.parentNode.classList.contains('task-placeholder-edit')
    ) {
